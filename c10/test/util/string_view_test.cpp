...
TEST(StringViewTest, whenCallingAccessOperatorOutOfRange_thenThrows) {
  expectThrows<std::out_of_range>(
      ...
      "string_view_ext::operator[] or string_view_ext::at() out of range. Index: 1, size: 0");

  expectThrows<std::out_of_range>(
      [] { string_view_ext("hello").at(5); },
      "string_view_ext::operator[] or string_view_ext::at() out of range. Index: 5, size: 5");

  expectThrows<std::out_of_range>(
      [] { string_view_ext("hello").at(100); },
      "string_view_ext::operator[] or string_view_ext::at() out of range. Index: 100, size: 5");

  expectThrows<std::out_of_range>(
      [] { string_view_ext("hello").at(string_view_ext::npos); },
      "string_view_ext::operator[] or string_view_ext::at() out of range. Index: 18446744073709551615, size: 5");
}
} // namespace test_random_access
...
TEST(StringViewTest, whenRemovingTooLargePrefix_thenThrows) {
  expectThrows<std::out_of_range>(
      ...
      "basic_string_view_ext::remove_prefix: out of range. PrefixLength: 6, size: 5");
}
} // namespace test_remove_prefix
...
TEST(StringViewTest, whenRemovingTooLargeSuffix_thenThrows) {
  expectThrows<std::out_of_range>(
      ...
      "basic_string_view_ext::remove_suffix: out of range. SuffixLength: 6, size: 5");
}
} // namespace test_remove_suffix
...
TEST(StringViewTest, whenCopyingOutOfRange_thenThrows) {
  ...
  expectThrows<std::out_of_range>(
      ...
      "basic_string_view_ext::copy: out of range. Index: 6, size: 5");
}
} // namespace test_copy
...
TEST(StringViewTest, whenCallingSubstrWithPosOutOfRange_thenThrows) {
  expectThrows<std::out_of_range>(
      ...
      "basic_string_view_ext::substr parameter out of bounds. Index: 6, size: 5");
